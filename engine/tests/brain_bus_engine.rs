...
fn brain_bus_control_matches_golden_digest_and_reasons() {
    ...
    let expected_digest: [u8; 32] = [
        0x64, 0x6e, 0xeb, 0xe2, 0x20, 0xd1, 0x86, 0xb8, 0xf2, 0x61, 0xef, 0xe2, 0x8d, 0x09, 0x70,
        0xc2, 0x93, 0x01, 0x13, 0x7f, 0x3a, 0x82, 0x57, 0x84, 0xed, 0x21, 0x94, 0x51, 0xed, 0x88,
        0xd0, 0x64,
    ];
    assert_eq!(digest.as_slice(), expected_digest);

    let expected_reasons = vec![1, 30, 40, 44, 45, 47, 53, 56, 58];
